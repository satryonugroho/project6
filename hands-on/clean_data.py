...
sensor_df = spark \
    .readStream \
    .format("kafka") \
    .option("kafka.bootstrap.servers", "pkc-ew3qg.asia-southeast2.gcp.confluent.cloud:9092") \
    .option("subscribe", "satryo_np-data-raw") \
    .option("startingOffsets", "earliest") \
    .option("kafka.security.protocol", "SASL_SSL") \
    .option("kafka.sasl.mechanism", "PLAIN") \
    .option("kafka.sasl.username", "2TB7KBGIO63OBJ2U") \
    .option("kafka.sasl.password", "/t+EMzb7ILzAxVJW7uy/aOcfW5JArir/h0l7B3ooEiXvPnZbRuX7yM72ME5kJfbG") \
    .option("kafka.sasl.jaas.config", """org.apache.kafka.common.security.plain.PlainLoginModule required username="2TB7KBGIO63OBJ2U" password="/t+EMzb7ILzAxVJW7uy/aOcfW5JArir/h0l7B3ooEiXvPnZbRuX7yM72ME5kJfbG";""") \
    .load()
...
clean_df = select_df.withColumn(
    "water_temperature", select_df['water_temperature'])
...
query = clean_df.selectExpr("CAST(measurement_id AS STRING) AS key", "to_json(struct(*)) AS value") \
    ...
    .option("kafka.bootstrap.servers", "pkc-ew3qg.asia-southeast2.gcp.confluent.cloud:9092") \
    .option("topic", "satryo_np-data-clean") \
    .option("kafka.security.protocol", "SASL_SSL") \
    .option("kafka.sasl.mechanism", "PLAIN") \
    .option("kafka.sasl.username", "2TB7KBGIO63OBJ2U") \
    .option("kafka.sasl.password", "/t+EMzb7ILzAxVJW7uy/aOcfW5JArir/h0l7B3ooEiXvPnZbRuX7yM72ME5kJfbG") \
